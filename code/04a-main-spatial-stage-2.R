# 04a-main-spatial-stage-2.R: script to fit Stage 2 of the multivariate
...
save(out, file = paste0(out.dir, 'stage-2-spatial-', n.samples, '-samples-', n.factors,
...
save(beta.samples, theta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-2-spatial-', n.samples, '-samples-',
