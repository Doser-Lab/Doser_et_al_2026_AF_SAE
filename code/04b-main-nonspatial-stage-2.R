# 04b-main-nonspatial-stage-2.R: script to fit Stage 2 of the multivariate
#                                SAE model without spatial random effects
#                                and with province level effects.
# Author: Jeffrey W. Dsoer
rm(list = ls())
library(spAbundance)
...
save(out, file = paste0(out.dir, 'stage-2-nonspatial-', n.samples, '-samples-', n.factors,
...
save(beta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-2-nonspatial-', n.samples, '-samples-',
