# 01c-main-spatial-noRE.R: script to fit the spatial linear mixed model 
#                          without the province-level random effects with 
#                          cross-validation. 
...
save(out, file = paste0(out.dir, 'ho-ba-univ-spatial-noRE-', n.samples, '-samples-', 
                        Sys.Date(), '.rda'))
