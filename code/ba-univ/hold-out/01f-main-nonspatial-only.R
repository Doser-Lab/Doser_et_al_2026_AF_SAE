# 01f-main-nonspatial-only.R: script to fit the a constant linear model 
#                             for small area estimation of basal area 
#                             across eastern Afghanistan for cross-validation. 
...
save(out, file = paste0(out.dir, 'ho-ba-univ-nonspatial-only-', n.samples, '-samples-', 
                        Sys.Date(), '.rda'))
