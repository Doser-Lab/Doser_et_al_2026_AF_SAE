# 03b-main-nonspatial-stage-1.R: script to fit Stage 1 of the multivariate
...
save(out, file = paste0(out.dir, 'stage-1-nonspatial-', n.samples, '-samples-', n.factors,
...
save(beta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-1-nonspatial-', n.samples, '-samples-',
