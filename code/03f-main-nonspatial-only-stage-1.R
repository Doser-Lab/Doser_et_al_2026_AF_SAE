# 03f-main-nonspatial-only-stage-1.R: script to fit Stage 1 of the multivariate
#                                     SAE model without spatial random effects
#                                     and with unstructured province level effects, 
#                                     and without any covariates.
...
save(out, file = paste0(out.dir, 'stage-1-nonspatial-only-', n.samples, '-samples-', n.factors,
...
save(beta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-1-nonspatial-only-', n.samples, '-samples-',
