# 01d-ho-random-main-nonspatial-noRE-stage-1.R: script to fit Stage 1 of the multivariate
...
save(out, file = paste0(out.dir, 'ho-random-stage-1-nonspatial-noRE-', n.samples, '-samples-', n.factors,
