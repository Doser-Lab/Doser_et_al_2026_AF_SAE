# 01f-ho-random-main-nonspatial-only-stage-1.R: script to fit Stage 1 of the multivariate
#                                               SAE model without spatial random effects
#                                               and with unstructured province level effects, 
#                                               and without any covariates for cross-validation.
...
save(out, file = paste0(out.dir, 'ho-random-stage-1-nonspatial-only-', n.samples, '-samples-', n.factors,
