# 02c-ho-random-main-spatial-noRE-stage-2.R: script to fit Stage 2 of the multivariate
...
save(out, file = paste0(out.dir, 'ho-random-stage-2-spatial-noRE-', n.samples, '-samples-', n.factors,
