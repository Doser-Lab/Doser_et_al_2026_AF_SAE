# 02f-ho-random-main-nonspatial-only-stage-2.R: script to fit Stage 2 of the multivariate
#                                               SAE model without spatial random effects
#                                               and without province level effects and 
#                                               without covariates for cross-validation.
...
save(out, file = paste0(out.dir, 'ho-random-stage-2-nonspatial-only-', n.samples, '-samples-', n.factors,
