# 02d-ho-random-main-nonspatial-noRE-stage-2.R: script to fit Stage 2 of the multivariate
...
save(out, file = paste0(out.dir, 'ho-random-stage-2-nonspatial-noRE-', n.samples, '-samples-', n.factors,
