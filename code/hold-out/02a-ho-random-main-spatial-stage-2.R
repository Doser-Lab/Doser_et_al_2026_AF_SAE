# 02a-ho-random-main-spatial-stage-2.R: script to fit Stage 2 of the multivariate
...
save(out, file = paste0(out.dir, 'ho-random-stage-2-spatial-', n.samples, '-samples-', n.factors,
