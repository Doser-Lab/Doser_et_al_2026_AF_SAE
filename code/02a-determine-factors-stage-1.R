# 02a-determine-factors-stage-1.R: script to do some preliminary runs of the 
...
for (i in n.factors) {
  ...
  save(waic.out, file = paste0(out.dir, 'prelim-stage-1-waic-', i, '-factors-',
                               Sys.Date(), '.rda'))
  rm(out)
  gc()
}
