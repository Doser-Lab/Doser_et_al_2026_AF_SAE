# 04f-main-nonspatial-only-stage-2.R: script to fit Stage 2 of the multivariate
#                                     SAE model without spatial random effects
#                                     and without province level effects and 
#                                     without covariates.
...
save(out, file = paste0(out.dir, 'stage-2-nonspatial-only-', n.samples, '-samples-', n.factors,
...
save(beta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-2-nonspatial-only-', n.samples, '-samples-',
