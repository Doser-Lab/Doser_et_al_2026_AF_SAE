# 03e-main-spatial-only-stage-1.R: script to fit Stage 1 of the multivariate
...
save(out, file = paste0(out.dir, 'stage-1-spatial-only-', n.samples, '-samples-', n.factors,
...
save(beta.samples, theta.samples, lambda.samples, beta.comm.samples,
     ...
     file = paste0(out.dir, 'small-stage-1-spatial-only-', n.samples, '-samples-',
